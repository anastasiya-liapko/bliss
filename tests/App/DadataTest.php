...
class DadataTest extends TestCase
{
    ...
    /**
     * Tests the getAddressInfo method.
     *
     * @return void
     * @throws \Exception
     */
    public function testGetAddressInfo(): void
    {
        ...
        $handler = HandlerStack::create($mock);
        $morpher = new Dadata($handler, $handler_telegram_bot);
        $this->assertIsArray($morpher->getAddressInfo('г. Москва ул. Ленина, 5'));
        $this->assertFalse($morpher->getAddressInfo('г. Москва ул. Ленина, 5'));
    }
}
