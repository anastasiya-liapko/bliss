...
function JoiningApplicationForEntrepreneurCard() {
  const uploadTemplateUrl = `${Helper.getLocation()}/admin-panel/document-templates
    /upload-document-joining-application-for-entrepreneur`;

  return (
    <div className="card mb-4">
      <div className="card-body">
        <h5 className="card-title">Обновить заявление о присоединении для ИП</h5>
        ...
        <p className="card-text">Загружать можно только в формате docx, другие форматы приниматься и обрабатываться не
          будут.</p>
        <UploadTemplateForm
          id="documentJoiningApplicationForEntrepreneur"
          name="document_joining_application_for_entrepreneur"
          label="Заявление о присоединении для ИП"
...
export default JoiningApplicationForEntrepreneurCard;
