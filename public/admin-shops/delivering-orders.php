<?php
  ...
  1 => 'admin',
	...
	function renderPage()
{
    return '<div id="page-delivering-orders"></div>
            ...
            <script src="/assets/shop-admin-panel/delivering-orders.js?ver=' . PANEL_VERSION . '"></script>
	...
	$actions[''] = function()
	{
		...
		<div class="content-header">
			<div class="btn-wrap">
				<h2><a href="#" class="back-btn"><span class="fa fa-arrow-circle-left"></span></a> '."Ожидают доставки".' </h2>
			</div>
		</div>
		<div>
	</div>';
	...
	echo masterRender("Ожидают доставки", $content, 1);
