<?php
  ...
  1 => 'admin',
	...
	function renderPage()
{
    return '<div id="page-failed-orders"></div>
            ...
            <script src="/assets/shop-admin-panel/failed-orders.js?ver=' . PANEL_VERSION . '"></script>
	...
	$actions[''] = function()
	{
		...
		<div class="content-header">
			<div class="btn-wrap">
				<h2><a href="#" class="back-btn"><span class="fa fa-arrow-circle-left"></span></a> '."Отмененные заказы".' </h2>
			</div>
		</div>
		<div>
	</div>';
	...
	echo masterRender("Отмененные заказы", $content, 3);
