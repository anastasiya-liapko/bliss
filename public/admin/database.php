<?php
  ...
  0 => 'super_admin',
	...
	function renderPage()
{
 return '<div id="page-data-base-job"></div>
 ...
 <script src="/assets/admin-panel/data-base-job.js?ver=' . PANEL_VERSION . '"></script>';
}
	...
	$actions[''] = function()
	{
		...
		<div class="content-header">
			<div class="btn-wrap">
				<h2><a href="#" class="back-btn"><span class="fa fa-arrow-circle-left"></span></a> '."Работа с базой данных".' </h2>
			</div>
		</div>
		<div>
	</div>';
	...
	echo masterRender("Работа с базой данных", $content, 12);
