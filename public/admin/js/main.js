...
$('input[name="snils"]').inputmask('999-999-999 99');
$('input[name="passport_number"]').inputmask('99 99 999999');
$('input[name="reg_zip_code"]').inputmask('999999');
$('input[name="fact_zip_code"]').inputmask('999999');
