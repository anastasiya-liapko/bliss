	...
	function renderPage()
{
 ...
 <script src="/assets/admin-panel/logs.js?ver=' . PANEL_VERSION . '"></script>';
}
	...
	$actions[''] = function()
	{
		...
		<div class="content-header">
			<div class="btn-wrap">
				<h2><a href="#" class="back-btn"><span class="fa fa-arrow-circle-left"></span></a> '."Скачать логи".' </h2>
			</div>
		</div>
		<div>
	</div>';
	...
	echo masterRender("Скачать логи", $content, 11);
